...
const PROPERTY_TYPES = ['Flat', 'Plot', 'Villa', 'Resort', 'Shop', 'Office'];
const AVAILABILITY_TYPES = ['buy'];
...
const AFFORDABILITY_TYPES = ['luxury', 'affordable'];
...
const Update = () => {
  ...
  // Initialize amenities state from fetched data
  useEffect(() => {
    if (formData.amenities && typeof formData.amenities === 'string') {
      try {
        const parsedAmenities = JSON.parse(formData.amenities.replace(/'/g, '"'));
        setFormData(prev => ({
          ...prev,
  ...
  const handleImageChange = (e) => {
    ...
    // Get existing images and new files
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formdata.append('affordability', formData.affordability);
